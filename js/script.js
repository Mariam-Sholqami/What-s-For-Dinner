...
function renderMeal(meal) {
    ...
    document.getElementById("recipe-image").alt = meal.title;

    document.getElementById("rating-average").innerHTML = meal.rating;
    document.getElementById("rating-quantity").innerHTML = meal.reviews;

    document.getElementById("prep-time-display").innerHTML = meal.prepTime;
    document.getElementById("cook-time-display").innerHTML = meal.cookTime;
    document.getElementById("servings-display").innerHTML = meal.servings;

    document.getElementById("difficulty-badge").innerHTML = meal.difficulty;
    document.getElementById("category-badge").innerHTML = meal.category;

    document.getElementById("recipe-name").innerHTML = meal.title;
    document.getElementById("recipe-description").innerHTML = meal.description;

  // showTimeWarning
  const warningBox = document.getElementById("time-warning");
  if (meal.showTimeWarning) {
...
for (var i = 0; i < meal.instructions.length; i++) {
    ...
    <div class="instruction-item">
        ...
        <span class="num-badge-lg">${i + 1}</span>

        <p>${meal.instructions[i]}</p>
...
document.getElementById("calories-value").innerHTML = meal.nutrition.calories;

document.getElementById("protein-value").innerHTML = meal.nutrition.protein;

document.getElementById("carbs-value").innerHTML = meal.nutrition.carbs;

document.getElementById("fat-value").innerHTML = meal.nutrition.fat;

document.getElementById("fiber-value").innerHTML = meal.nutrition.fiber;

document.getElementById("sodium-value").innerHTML = meal.nutrition.sodium;
